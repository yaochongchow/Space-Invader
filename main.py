...
BLUE_ENEMY = pygame.image.load(os.path.join("assets", "Red_enemy.png"))
...
class Ship:
    ...
    def move_lasers(self, vel, obj):
        ...
        for laser in self.lasers:
            ...
            if laser.off_screen(HEIGHT):
                ...
                obj.health -= 10
                self.lasers.remove(laser)
                EXPLOSION_SOUND.play()  # Play explosion sound effect
    ...
    def shoot(self):
        if self.cool_down_counter == 0:
            ...
            self.cool_down_counter = 1
            LASER_SOUND.play()  # Play laser sound effect
